...
var smoothScroll_polyfills = {exports: {}};
...
function membersTitleAnimation() {
	gsap__default["default"].registerPlugin(ScrollTrigger__default["default"]);

	gsap__default["default"].from('.memberg__title img', {
		scrollTrigger: {
			start: 'top: 100%',
